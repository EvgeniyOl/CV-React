...
const MyProjects = (props) => {
   ...
   return (
      <div class={styles.container}>
         ...
         <hr size="5" />
         <p>Пятый проект - <a href="https://skb-3wwbrbxj6-evgeniyol.vercel.app/" target="blank">Сайт для фирмы SKB</a></p>
         <ul>
         ...
         <hr size="5" />
         <p>Седьмой проект - <a href="#" target="blank">аналог Slack-чата (очень упрощенная версия)</a></p>
         <ul>
            <li>Проект еще в разработке. </li>
            <li>
               Дипломный проект строится на технологиях, используемых в повседневной работе фронтенд-разработчиками
               в целом и React-разработчиками в частности.
               Его цель - показать спектр всех стандартных задач, с которыми придётся столкнуться в реальной жизни.
               Среди них: работа с веб-сокетами, взаимодействие с REST API,
               использование React (с хуками), Redux (через reduxjs/toolkit),
               организация роутинга на клиента, авторизация и аутентификация и, конечно же, сборка (webpack) и деплой (heroku).
            </li>
         </ul>
      </div>
